...
export const Typography = {
  displayXL: { fontFamily: 'Nunito_900Black', fontSize: 36, letterSpacing: -0.5 },
  displayL: { fontFamily: 'Nunito_800ExtraBold', fontSize: 28 },
  displayM: { fontFamily: 'Nunito_800ExtraBold', fontSize: 22 },
  headingL: { fontFamily: 'Nunito_700Bold', fontSize: 18 },
  headingM: { fontFamily: 'Nunito_700Bold', fontSize: 16 },
  headingS: { fontFamily: 'Nunito_600SemiBold', fontSize: 14 },
  bodyL: { fontFamily: 'Outfit_400Regular', fontSize: 14, lineHeight: 22 },
  bodyM: { fontFamily: 'Outfit_400Regular', fontSize: 13, lineHeight: 20 },
  bodyS: { fontFamily: 'Outfit_400Regular', fontSize: 12 },
  label: { fontFamily: 'Nunito_600SemiBold', fontSize: 11, letterSpacing: 1.5 },
  mono: { fontFamily: 'Nunito_900Black', fontSize: 48, letterSpacing: 2 },
} as const;
